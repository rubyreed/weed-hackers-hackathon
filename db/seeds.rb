...
Job.create(titile: "Lead Gardener", salary: 25.50)
Job.create(titile: "Laborer", salary: 15.50)
Job.create(titile: "Sr. Botonist", salary: 57.75)
Job.create(titile: "Asst. Bottonist", salary: 32.50)
Job.create(titile: "Florist", salary: 22.50)
Job.create(titile: "Lady Bug Placer", salary: 17.50)
Job.create(titile: "Trimmer", salary: 21.50)
Job.create(titile: "Counter Person", salary: 15.50)
Job.create(titile: "Flower Salesman", salary: 25.50)
Job.create(titile: "Shop layout designer", salary: 18.50)
